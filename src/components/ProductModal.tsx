                    ...
                    >
                        ...
                        <div className="lg:w-1/2 p-6 lg:p-16 overflow-y-auto">
                            ...
                            <div className="space-y-6">
                                ...
                                <button
                                    onClick={() => window.open(`/api/products/${model._id}/brochure`, '_blank')}
                                    className="w-full py-4 bg-[#14211A] text-white text-[10px] font-bold tracking-[0.3em] uppercase hover:bg-[#D4AF37] transition-all shadow-xl flex items-center justify-center gap-2"
                                >

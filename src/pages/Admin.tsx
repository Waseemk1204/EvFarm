...
export function Admin() {
    ...
    const validTabs = ['dashboard', 'inquiries', 'blogs', 'products', 'content'] as const;
                ...
                <div className="p-8">
                    ...
                    <nav className="space-y-2">
                        {[
                            ...
                            { id: 'content', icon: Edit3, label: 'Site Content' },
                        ].map((item) => (
                            <button
                                key={item.id}
            ...
            <main className="flex-1 lg:ml-72 ml-0 p-6 lg:p-12 transition-all duration-300">
                ...
                {activeTab === 'content' && siteContent && (
                    <div className="space-y-8 pb-20">
                        <div className="bg-white p-8 rounded-sm shadow-sm border border-[#14211A]/5">
                            <div className="flex justify-between items-center mb-8 pb-4 border-b border-[#14211A]/5">
                                <h2 className="text-xl font-bold text-[#14211A]">Branding & Logo</h2>
                                <button
                                    onClick={handleSaveContent}
                                    className="flex items-center gap-2 px-5 py-2.5 bg-[#14211A] text-white text-sm font-bold rounded-sm hover:bg-[#D4AF37] transition-all shadow-sm"
                                >
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                                <div className="space-y-6">
                                    <div>
                                        <label className="block text-[10px] font-bold uppercase tracking-[0.2em] text-[#14211A]/40 mb-4">Website Logo</label>
                                        <div className="flex flex-col sm:flex-row items-center sm:items-start gap-6">
                                            <div className="w-32 h-32 bg-[#F8F9F8] border border-[#14211A]/10 rounded-full overflow-hidden flex items-center justify-center relative shadow-inner shrink-0">
                                                <img src={siteContent.siteLogo || "/logo.png"} alt="Logo" className="w-full h-full object-contain" />
                                                {uploading && (
                                ...
                                <div className="space-y-6">
                                    <div>
                                        <label className="block text-[10px] font-bold uppercase tracking-[0.2em] text-[#14211A]/40 mb-3">Site Email</label>
                                        <input
                                            type="text"
                                    ...
                                    <div>
                                        <label className="block text-[10px] font-bold uppercase tracking-[0.2em] text-[#14211A]/40 mb-3">Site Phone</label>
                                        <input
                                            type="text"
                        ...
                        <div className="bg-white p-8 rounded-sm shadow-sm border border-[#14211A]/5">
                            <h2 className="text-xl font-bold text-[#14211A] mb-8 pb-4 border-b border-[#14211A]/5">Hero Section</h2>
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                ...
                                <div>
                                    <label className="block text-[10px] font-bold uppercase tracking-[0.2em] text-[#14211A]/40 mb-3">Highlight</label>
                                    <input
                                        type="text"
                                ...
                                <div className="md:col-span-2">
                                    <label className="block text-[10px] font-bold uppercase tracking-[0.2em] text-[#14211A]/40 mb-3">Subtitle</label>
                                    <textarea
                                        rows={3}
                        ...
                        <div className="bg-white p-8 rounded-sm shadow-sm border border-[#14211A]/5">
                            <h2 className="text-xl font-bold text-[#14211A] mb-8 pb-4 border-b border-[#14211A]/5">About Section</h2>
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                <div>
                                    <label className="block text-[10px] font-bold uppercase tracking-[0.2em] text-[#14211A]/40 mb-3">Title</label>
                                    <input
                                ...
                                <div>
                                    ...
                                    <input
                                        type="text"
                                        value={siteContent.aboutTitleHighlight || ''}
                                        onChange={(e) => setSiteContent({ ...siteContent, aboutTitleHighlight: e.target.value })}
                                        className="w-full px-4 py-3 bg-[#F8F9F8] border border-[#14211A]/5 rounded-sm focus:outline-none focus:ring-1 focus:ring-[#14211A]/10"
                                    />
                                </div>
                                <div className="md:col-span-2">
                                    <label className="block text-[10px] font-bold uppercase tracking-[0.2em] text-[#14211A]/40 mb-3">Description</label>
                                    <textarea
                                        rows={4}
                ...
                {isEditing && (
                    <div className="fixed inset-0 z-50 flex items-center justify-center p-6">
                        ...
                        <motion.div
                            ...
                            className="relative w-full max-w-2xl bg-white rounded-sm shadow-2xl overflow-hidden max-h-[90vh] overflow-y-auto"
                        >
                            <div className="p-8 border-b border-[#14211A]/5 flex justify-between items-center sticky top-0 bg-white z-10">
                                <h2 className="font-display text-2xl font-bold text-[#14211A]">
                                    {editType === 'blog' ? (formData._id ? 'Edit Blog' : 'New Blog') : (formData._id ? 'Edit Product' : 'New Product')}
                                </h2>
                                <button onClick={() => setIsEditing(false)} className="text-[#14211A]/40 hover:text-[#14211A] transition-all">
                                    <X className="w-6 h-6" />
                                </button>
                            </div>
                            ...
                            <div className="p-8 space-y-6">
                                {editType === 'blog' ? (
                                    <>
                                        <div>
                                            <label className="block text-[10px] font-bold uppercase tracking-[0.2em] text-[#14211A]/40 mb-2">Title</label>
                                            <input
                                                type="text"
                                                value={formData.title || ''}
                                                onChange={(e) => setFormData({ ...formData, title: e.target.value })}
                                                className="w-full px-4 py-3 bg-[#F8F9F8] border border-[#14211A]/5 rounded-sm focus:outline-none focus:ring-2 focus:ring-[#D4AF37]/30"
                                                placeholder="Blog title"
                                            />
                                        </div>
                                        <div>
                                            <label className="block text-[10px] font-bold uppercase tracking-[0.2em] text-[#14211A]/40 mb-2">Content</label>
                                            <textarea
                                                rows={8}
                                    ...
                                    <>
                                        <div className="grid grid-cols-2 gap-6">
                                            <div>
                                                <label className="block text-[10px] font-bold uppercase tracking-[0.2em] text-[#14211A]/40 mb-2">Name</label>
                                                <input
                                                    type="text"
                                                    value={formData.name || ''}
                                            ...
                                            <div>
                                                <label className="block text-[10px] font-bold uppercase tracking-[0.2em] text-[#14211A]/40 mb-2">Seating</label>
                                                <input
                                                    type="number"
                                        ...
                                        <div>
                                            <label className="block text-[10px] font-bold uppercase tracking-[0.2em] text-[#14211A]/40 mb-2">Tagline</label>
                                            <input
                                                type="text"
                                        ...
                                        <div className="space-y-4">
                                            ...
                                            <div className="flex gap-4">
                                                <div className="w-32 h-32 bg-[#F8F9F8] border border-[#14211A]/5 rounded-sm overflow-hidden flex items-center justify-center relative group">
                                                    {formData.image ? (
                                                        <img src={formData.image} alt="Preview" className="w-full h-full object-cover" />
                                                    ) : (
                                                        <div className="text-[#14211A]/20 flex flex-col items-center">
                                                ...
                                                <div className="flex-1 space-y-3">
                                                    <input
                                                        ...
                                                        className="w-full px-4 py-3 bg-[#F8F9F8] border border-[#14211A]/5 rounded-sm text-xs focus:outline-none focus:ring-1 focus:ring-[#14211A]/10"
                                                    ...
                                                    <button
                                                        ...
                                                        className="flex items-center gap-2 px-6 py-3 bg-[#F8F9F8] border border-[#14211A]/10 text-[10px] font-bold uppercase tracking-widest text-[#14211A] hover:bg-[#14211A] hover:text-white transition-all w-full"
                                                    >
                                                        {uploading ? (
                                        ...
                                        <div className="grid grid-cols-2 gap-6">
                                            <div>
                                                <label className="block text-[10px] font-bold uppercase tracking-[0.2em] text-[#14211A]/40 mb-2">Speed</label>
                                                <input
                                                    type="text"
                                            ...
                                            <div>
                                                <label className="block text-[10px] font-bold uppercase tracking-[0.2em] text-[#14211A]/40 mb-2">Range</label>
                                                <input
                                                    type="text"
                                        ...
                                        <div className="border-t border-[#14211A]/10 pt-6 mt-6">
                                            <h3 className="text-[10px] font-bold uppercase tracking-[0.2em] text-[#14211A]/60 mb-4">Technical Specifications</h3>
                                            <div className="grid grid-cols-2 gap-6">
                                                <div>
                                                    <label className="block text-[10px] font-bold uppercase tracking-[0.2em] text-[#14211A]/40 mb-2">Battery Type</label>
                                                    <input
                                                        type="text"
                                                ...
                                                <div>
                                                    <label className="block text-[10px] font-bold uppercase tracking-[0.2em] text-[#14211A]/40 mb-2">Battery Capacity</label>
                                                    <input
                                                        type="text"
                                                ...
                                                <div>
                                                    <label className="block text-[10px] font-bold uppercase tracking-[0.2em] text-[#14211A]/40 mb-2">Motor Power</label>
                                                    <input
                                                        type="text"
                                                ...
                                                <div>
                                                    <label className="block text-[10px] font-bold uppercase tracking-[0.2em] text-[#14211A]/40 mb-2">Charging Time</label>
                                                    <input
                                                        type="text"
                                                ...
                                                <div>
                                                    <label className="block text-[10px] font-bold uppercase tracking-[0.2em] text-[#14211A]/40 mb-2">Dimensions</label>
                                                    <input
                                                        type="text"
                                                        value={formData.dimensions || ''}
                                                        onChange={(e) => setFormData({ ...formData, dimensions: e.target.value })}
                                                        className="w-full px-4 py-3 bg-[#F8F9F8] border border-[#14211A]/5 rounded-sm focus:outline-none focus:ring-1 focus:ring-[#14211A]/10"
                                                        placeholder="e.g. 2400 × 1200 × 1800 mm"
                                                    />
                                                </div>
                                                <div>
                                                    <label className="block text-[10px] font-bold uppercase tracking-[0.2em] text-[#14211A]/40 mb-2">Ground Clearance</label>
                                                    <input
                                                        type="text"
                                        ...
                                        {/* Features */}
                                        <div>
                                            <label className="block text-[10px] font-bold uppercase tracking-[0.2em] text-[#14211A]/40 mb-2">Features (comma-separated)</label>
                                            <textarea
                                                rows={3}
                                                value={Array.isArray(formData.features) ? formData.features.join(', ') : (formData.features || '')}
                                                onChange={(e) => setFormData({ ...formData, features: e.target.value.split(',').map((f: string) => f.trim()).filter((f: string) => f) })}
                                                className="w-full px-4 py-3 bg-[#F8F9F8] border border-[#14211A]/5 rounded-sm focus:outline-none focus:ring-1 focus:ring-[#14211A]/10"
                                                placeholder="e.g. Regenerative braking, LED headlights, Digital cluster"
                                            />
                                        </div>
                                    </>
                                )}
                            ...
                            <div className="p-8 bg-[#F8F9F8] flex justify-end gap-3 sticky bottom-0">
                                <button
                                    onClick={() => setIsEditing(false)}
                                    className="px-6 py-3 font-bold text-[#14211A]/50 hover:text-[#14211A] transition-all"
                                >
                                    Cancel
                                </button>
                                <button
                                    onClick={handleSave}
                                    className="px-8 py-3 bg-[#14211A] text-white font-bold rounded-sm hover:bg-[#D4AF37] transition-all flex items-center gap-2"
                                >
                                    <Save className="w-4 h-4" />
                                    Save
                                </button>
                ...
                {confirmModal.show && (
                    ...
                    >
                        <motion.div
                            ...
                            className="bg-white rounded-sm shadow-2xl p-6 max-w-md w-full mx-4"
                            onClick={e => e.stopPropagation()}
                        >
                            <h3 className="text-lg font-bold text-[#14211A] mb-2">{confirmModal.title}</h3>
                            <p className="text-[#14211A]/60 mb-6">{confirmModal.message}</p>
                            <div className="flex gap-3 justify-end">
                                <button
                                    onClick={() => setConfirmModal({ ...confirmModal, show: false })}
                                    className="px-4 py-2 bg-gray-100 text-gray-700 font-medium rounded-sm hover:bg-gray-200 transition-all"
                                >
                                    Cancel
                                </button>
                                <button
            ...
            <AnimatePresence>
                {toast.show && (
                    <motion.div
                        ...
                        animate={{ opacity: 1, y: 0 }}
                        exit={{ opacity: 0, y: 50 }}
                        className={`fixed bottom-6 right-6 px-6 py-3 rounded-sm shadow-lg z-50 ${toast.type === 'success'
